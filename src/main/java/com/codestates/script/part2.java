...
public class part2 {
  ...
  */
  public static final String PART2_3 = "INSERT INTO user (name, email) VALUES ('kimcoding', 'kimcoding@codestates.com');";
  ...
  */
  public static final String PART2_4 = "SELECT * FROM user WHERE user.name='luckykim';";
  ...
  */
  public static final String PART2_5 = "SELECT * FROM user WHERE user.name <> 'luckykim';";
  ...
  */
  public static final String PART2_10 = "INSERT INTO content(title, body, userID) VALUES ('codestates', 'I love coding', 1);";
}
